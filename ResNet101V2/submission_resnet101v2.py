...
WEIGHT_PATH = "./ResNet101V2/LR_0.00001/epoch_9_train_acc_0.822.h5"
...
backbone = tf.keras.applications.ResNet101V2(include_top=False, weights=None, input_shape=[IMAGE_MAX_SIZE, IMAGE_MAX_SIZE, 3], classifier_activation=None)
