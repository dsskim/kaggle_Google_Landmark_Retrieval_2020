...
WEIGHT_DECAY = 0.0005
WEIGHT_PATH = "./InceptionV3/LR=0.00001_weight_decay_0.0005_semi-adacos/epoch_19_train_acc_0.809.h5"
...
backbone = tf.keras.applications.InceptionV3(include_top=False, weights=None, input_shape=[IMAGE_MAX_SIZE, IMAGE_MAX_SIZE, 3])
...
tf.saved_model.save(m, export_dir="./10_output_inception_v3", signatures={'serving_default': served_function})
