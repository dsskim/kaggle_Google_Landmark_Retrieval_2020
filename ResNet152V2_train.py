...
train_tfrec_dir = '/ssd_2tb/dsskim/landmark_2020/train*'
valid_tfrec_dir = "/ssd_2tb/dsskim/landmark_2020/valid*"
...
model.compile(optimizer=tf.keras.optimizers.Adam(learning_rate=tf.keras.experimental.CosineDecay(initial_learning_rate=0.001, decay_steps=EPOCHS)),
