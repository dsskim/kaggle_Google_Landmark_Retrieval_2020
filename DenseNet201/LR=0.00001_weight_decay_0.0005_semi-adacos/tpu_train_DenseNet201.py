...
with strategy.scope():
    backbone = tf.keras.applications.DenseNet201(include_top=False, weights='imagenet', input_shape=[IMAGE_MAX_SIZE, IMAGE_MAX_SIZE, 3])
...
entire_model.compile(optimizer=tf.keras.optimizers.Adam(learning_rate=LR_START),
