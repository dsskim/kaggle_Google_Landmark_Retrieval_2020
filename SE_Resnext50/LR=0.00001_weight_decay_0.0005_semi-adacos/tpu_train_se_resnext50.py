...
with strategy.scope():
    ...
    backbone = SEResNeXt50((IMAGE_MAX_SIZE, IMAGE_MAX_SIZE, 3), weights='imagenet', include_top=False, name='SEResNeXt50')
...
entire_model.compile(optimizer=tf.keras.optimizers.SGD(learning_rate = LR_START, momentum=0.9, nesterov=True),
